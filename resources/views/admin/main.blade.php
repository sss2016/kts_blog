...
<head>
    ...
    <link rel="shortcut icon" href="/image/Logo_40.png" type="image/x-icon">
    <!-- layui.css -->
                ...
                <ul class="layui-nav layui-nav-tree" lay-filter="leftnav">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="/admin/datalist" data-id="1">文章管理</a></dd>
                            <dd><a href="javascript:;" data-url="/admin/datalist" data-id="2">资源管理</a></dd>
                            <dd><a href="javascript:;" data-url="/admin/publish" data-id="3">发表文章</a></dd>
                            <dd><a href="javascript:;">笔记本管理</a></dd>
                            <dd><a href="javascript:;" data-url="/admin/datalist" data-id="4">文章回收站</a></dd>
